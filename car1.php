        ...
        <div class="position-relative px-lg-5" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="car1.php" class="nav-item nav-link active">Cars</a>
        ...
        <div class="row justify-content-center my-5">
          <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="d-flex flex-column align-items-center">
              <a href="getCars.php?category=BMW">  
                <img class="img img-fluid rounded-circle fixed-size" src="img/bmwlogo.jpeg" alt="first Category" style="height: 100px;"> 
              </a>
              <a class="text-center fw-bold text-decoration-none text-dark mt-2" href="#">BMW</a>
            </div>
          </div>
      
          <!-- Repeat the above structure for the remaining four categories -->
          ...
          <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="d-flex flex-column align-items-center">
              <a href="getCars.php?category=MERCEDES">  
                <img class="img img-fluid rounded-circle fixed-size" src="img/mercedeslogo1.jpeg" alt="second Category" style="height: 100px;"> 
              </a>
              <a class="text-center fw-bold text-decoration-none text-dark mt-2" href="#">MERCEDES</a>
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="d-flex flex-column align-items-center">
              <a href="getCars.php?category=TOYOTA">  
                <img class="img img-fluid rounded-circle fixed-size" src="img/toyotalogo.jpg" alt="first Category" style="height: 100px;"> 
              </a>
              <a class="text-center fw-bold text-decoration-none text-dark mt-2" href="#">TOYOTA</a>
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="d-flex flex-column align-items-center">
            <a href="getCars.php?category=HYNDAI">  
                <img class="img img-fluid rounded-circle fixed-size" src="img/hyndailogo5.jpeg" alt="first Category" style="height: 100px;"> 
              </a>
              <a class="text-center fw-bold text-decoration-none text-dark mt-2" href="#">HYNDAI</a>
            </div>
          </div>
          
          <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="d-flex flex-column align-items-center">
            <a href="getCars.php?category=KIA">  
                <img class="img img-fluid rounded-circle fixed-size" src="img/kialogo.png" alt="Fifth Category" style="height: 100px;">
              </a>
              <a class="text-center fw-bold text-decoration-none text-dark mt-2" href="#">KIA</a>
            </div>
          </div>
        </div>
      </div>
